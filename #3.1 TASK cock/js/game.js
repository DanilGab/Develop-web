function initiate() {
    ...
    function drawMedal(position, bug) {
        if (position == 1) {
            if (bug == 1) {canvas.drawImage(medalFirst, 300, 20); state1 = 1;}
            if (bug == 2) {canvas.drawImage(medalFirst, 300, 170); state1 = 2;}
            if (bug == 3) {canvas.drawImage(medalFirst, 300, 320); state1 = 3;}
            if (bug == 4) {canvas.drawImage(medalFirst, 300, 470); state1 = 4;}
        }
        if (position == 2) {
            if (bug == 1) { canvas.drawImage(medalSecond, 300, 20); state2 = 1; }
            if (bug == 2) { canvas.drawImage(medalSecond, 300, 170); state2 = 2; }
            if (bug == 3) { canvas.drawImage(medalSecond, 300, 320); state2 = 3; }
            if (bug == 4) { canvas.drawImage(medalSecond, 300, 470); state3 = 4; }
        }
        if (position == 3) {
            if (bug == 1) { canvas.drawImage(medalThird, 300, 20); state3 = 1; }
            if (bug == 2) { canvas.drawImage(medalThird, 300, 170); state3 = 2; }
            if (bug == 3) { canvas.drawImage(medalThird, 300, 320); state3 = 3; }
            if (bug == 4) { canvas.drawImage(medalThird, 300, 470); state3 = 4; }
        }
        if (position == 4) {
            if (bug == 1) { canvas.drawImage(medalFourth, 300, 20);}
            if (bug == 2) { canvas.drawImage(medalFourth, 300, 170);}
            if (bug == 3) { canvas.drawImage(medalFourth, 300, 320);}
            if (bug == 4) { canvas.drawImage(medalFourth, 300, 470);}
        }
    }
